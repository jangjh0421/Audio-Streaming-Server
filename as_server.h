...
**   -- using find_network_newline from the sockets lab will be helpful! A
**      modified version is included in libas.h.
**
** return 0 on success, -1 on error
*/
...
**
** Make the assumption that post_req is at least 4 bytes long.
**
